...
public class eReturnCountPaymenttApi {
    ...
    private static int eRetTotalSubmission;
    private static float eRetTotalPayment;
...
//    }
    ...
    public eReturnCountPaymenttApi() throws IOException {
        sendPOST();
...
//    }
    ...
    public static int getERetTotalSubmission() throws IOException {

        return eRetTotalSubmission;
    }

    public static float  getERetTotalPayment() throws IOException {
        return eRetTotalPayment;//TinCountRange;
    }
    ...
    private static void sendGET() throws IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) { // success
            ...
            eRetTotalSubmission = Integer.parseInt(totalsubm);
            eRetTotalPayment = Float.parseFloat(totalPayment);
